...
function Search(props) {
    ...
    const searchGames = () => {
        ...
        fetch(`${process.env.REACT_APP_SERVER_LINK}/api/games/?searchTerm=${searchTerm}`, requestOptions)
        .then(response => {
            if(!response.ok) {
    ...
    const searchUsers = () => {
        ...
        fetch(`${process.env.REACT_APP_SERVER_LINK}/api/users/?Username=${searchTerm}`, requestOptions)
        .then(response => {
            if(!response.ok) {
